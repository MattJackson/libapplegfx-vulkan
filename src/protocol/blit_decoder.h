 ...
 * src/protocol/blit_decoder.h
 *
 * Copyright © 2026 Matthew Jackson
 * SPDX-License-Identifier: AGPL-3.0-or-later
 *
 * Single entry point for dispatching one Blit inner opcode. The
 * dispatcher looks the opcode up in the descriptor table populated by
 * `blit_opcodes.c` and runs the descriptor's `default_handler`
...
#ifndef LIBAPPLEGFX_PROTOCOL_BLIT_DECODER_H
#define LIBAPPLEGFX_PROTOCOL_BLIT_DECODER_H
...
#endif /* LIBAPPLEGFX_PROTOCOL_BLIT_DECODER_H */
