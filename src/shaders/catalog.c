 ...
 * paravirt-re/shader-catalog-plan.md §4 and
 * paravirt-re/phase-3-metal-vulkan-plan.md §3.C. The catalog is
 ...
 *     (paravirt-re/command-buffer-format.md §12 FIXME).
...
bool lagfx_shader_catalog_log_miss(const uint8_t *air_bytes,
    ...
    /* The format string matches paravirt-re/shader-catalog-plan.md
