...
lagfx_handler_status_t lagfx_op_get_device_info(lagfx_protocol_t *p,
     ...
     * the internal spec Handled separately
...
lagfx_op_get_device_info_2(lagfx_protocol_t *p,
     ...
     * Keys per the internal spec (parser at 0x1455d41d, 42-case jump):
     ...
     */
    /*
     * Per an earlier agent's §15 RE: response-key content does NOT gate
