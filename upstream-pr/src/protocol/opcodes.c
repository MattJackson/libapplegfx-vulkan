...
static const lagfx_op_descriptor_t g_op_table[] = {
     ...
     * an earlier agent kext disasm (re-followup-spec-gaps.md §13.5):
     ...
     * Unknown(0x28) entry (an earlier agent kext disasm §13.5); §14.5
     ...
     *     viable device-info tuple stream. See the internal spec
     *
     *     The additional extended opcodes (0x31, 0x34..0x37, 0x39,
     *     0x3b, 0x3c, 0x41) are P2: an earlier agent's disasm enumerated their
