...
typedef enum {
     ...
     * Observed via an earlier agent's kext disasm of AppleParavirtGPU (re-followup-
     ...
     * live trace + kext disasm. See the internal spec */
 ...
 * an earlier agent's kext disasm (§13.5) enumerated 26 callsites covering extended
